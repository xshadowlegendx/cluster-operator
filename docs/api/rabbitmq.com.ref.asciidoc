...
| *`allowScaleDown`* __boolean__ | Set to true to allow scale down of the RabbitmqCluster. It defaults to false to prevent cluster scale down. Scale down is a dangerous operation. Do it at your own risk!
|===
